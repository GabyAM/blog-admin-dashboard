...
export function VerticalDotsIcon({ width = 24, height = 24 }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export function DeleteIcon({ width = 24, height = 24 }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export function PublishIcon({ width = 24, height = 24 }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export function UnpublishIcon({ width = 24, height = 24 }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="icon icon-tabler icons-tabler-outline icon-tabler-world-download"
        >
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            <path d="M21 12a9 9 0 1 0 -9 9" />
            <path d="M3.6 9h16.8" />
...
export function PromoteIcon({ width = 24, height = 24 }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export function BanIcon({ width = 24, height = 24 }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export function DemoteIcon({ width = 24, height = 24 }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="icon icon-tabler icons-tabler-outline icon-tabler-crown-off"
        >
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
export function UserRemoveIcon({ width = 24, height = 24 }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export function UnbanIcon({ width = 24, height = 24 }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export function ProfileIcon({ width = 24, height = 24 }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export function LogoutIcon({ width = 24, height = 24 }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export function ErrorIcon({ width = '1em', height = '1em', type = 'solid' }) {
    return type === 'solid' ? (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export function InfoIcon({ width = '1em', height = '1em' }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
